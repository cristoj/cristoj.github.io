var P=Object.defineProperty;var $=(r,e,t)=>e in r?P(r,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):r[e]=t;var s=(r,e,t)=>$(r,typeof e!="symbol"?e+"":e,t);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))n(i);new MutationObserver(i=>{for(const o of i)if(o.type==="childList")for(const a of o.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&n(a)}).observe(document,{childList:!0,subtree:!0});function t(i){const o={};return i.integrity&&(o.integrity=i.integrity),i.referrerPolicy&&(o.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?o.credentials="include":i.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function n(i){if(i.ep)return;i.ep=!0;const o=t(i);fetch(i.href,o)}})();class k{constructor(e=document.body){s(this,"targetElement");this.targetElement=e}render(e){let t="";e instanceof Error?(console.error(e.name,e.message),t+=`<p><strong>Error:</strong> ${e.name}: ${e.message}</p>`):(console.error(e),t+=`<p><strong>Error:</strong> Unknown error occurred: ${e}</p>`),this.targetElement.innerHTML=`
        ...
        `}setTargetElement(e){this.targetElement=e}}class I{constructor(e){this.repository=e}async execute(e){if(!e.getBasicInfo().email)throw new Error("El email es requerido");await this.repository.save(e)}}class v extends HTMLElement{constructor(){super()}disconnectedCallback(){this.remove()}connectedCallback(){this.initComponent()}render(){this.innerHTML=`
           <style>                
                ${this.templateCss()}
           </style>
           ${this.renderTemplate()}
        `}mapComponentAttributes(){}templateCss(){return""}renderTemplate(){return""}initComponent(){}}class E extends Error{constructor(e){super(e),this.name="PortfolioError"}}class M{constructor(e){this.repository=e}async execute(e){if(!e)throw new E("El uuid es requerido");return await this.repository.findById(e)}}const g=class g{constructor(){s(this,"store",new Map)}static getInstance(){return g.instance||(g.instance=new g),g.instance}async save(e){this.store.set(e.getUuid(),e)}async findById(e){return this.store.get(e)||null}async findAll(){return Array.from(this.store.values())}async update(e){const t=e.getUuid();if(!this.store.has(t))throw new Error("Portfolio not found");this.store.set(t,e)}async delete(e){if(!this.store.has(e))throw new Error("Portfolio not found");this.store.delete(e)}};s(g,"instance");let T=g;class D extends v{constructor(){super(...arguments);s(this,"uuid",null);s(this,"portfolio",null);s(this,"isLoading",!0);s(this,"error",null)}get uuidFromElement(){return this.uuid=this.getAttribute("uuid"),this.uuid}async initComponent(){if(!this.uuidFromElement){this.error="El atributo 'uuid' es requerido.",this.isLoading=!1,this.render();return}try{const t=new M(T.getInstance());this.portfolio=await t.execute(this.uuid),this.portfolio||(this.error="Portfolio no encontrado.")}catch(t){this.error="Error al cargar el portfolio.",console.error(t)}finally{this.isLoading=!1,this.render()}}renderTemplate(){if(this.isLoading)return"<p>Cargando portfolio...</p>";if(this.error)return`<p style="color: red;">${this.error}</p>`;if(!this.portfolio)return"<p>Portfolio no disponible.</p>";const t=this.portfolio.getBasicInfo(),n=this.portfolio.getTechnologies();return`
            <div>
        ...
        `}renderTechnologies(t){return t.map(n=>`<span class="tag tag--outline--primary">${n}</span>`).join("")}}class F extends v{constructor(){super(...arguments);s(this,"error",null);s(this,"uuids",[])}get uuidsFromElement(){var t;return this.uuids=((t=this.getAttribute("uuids"))==null?void 0:t.split(","))??[],this.uuids}async initComponent(){if(!this.uuidsFromElement){this.error="El atributo 'uuids' es requerido.",this.render();return}this.render()}renderTemplate(){return this.error?`<p style="color: red;">${this.error}</p>`:(window.customElements.get("portfolio-item")||window.customElements.define("portfolio-item",D),`
            <section
            ...
            </section>`)}}class y extends Error{constructor(e){super(e),this.name="TrainingError"}}class R{constructor(e){this.repository=e}async execute(e){if(!e)throw new y("El uuid es requerido");return await this.repository.findById(e)}}const f=class f{constructor(){s(this,"store",new Map)}static getInstance(){return f.instance||(f.instance=new f),f.instance}async save(e){this.store.set(e.getUuid(),e)}async findById(e){return this.store.get(e)||null}async findAll(){return Array.from(this.store.values())}async update(e){const t=e.getUuid();if(!this.store.has(t))throw new Error("Training not found");this.store.set(t,e)}async delete(e){if(!this.store.has(e))throw new Error("Training not found");this.store.delete(e)}};s(f,"instance");let U=f;class Z extends v{constructor(){super(...arguments);s(this,"uuid",null);s(this,"training",null);s(this,"isLoading",!0);s(this,"error",null)}get uuidFromElement(){return this.uuid=this.getAttribute("uuid"),this.uuid}async initComponent(){if(!this.uuidFromElement){this.error="El atributo 'uuid' es requerido.",this.isLoading=!1,this.render();return}try{const t=new R(U.getInstance());this.training=await t.execute(this.uuid),this.training||(this.error="Training no encontrado.")}catch(t){this.error="Error al cargar el training.",console.error(t)}finally{this.isLoading=!1,this.render()}}renderTemplate(){if(this.isLoading)return"<p>Cargando training...</p>";if(this.error)return`<p style="color: red;">${this.error}</p>`;if(!this.training)return"<p>Training no disponible.</p>";const t=this.training.getBasicInfo();return`
        ...
        `}}class j extends v{constructor(){super(...arguments);s(this,"error",null);s(this,"uuids",[])}get uuidsFromElement(){var t;return this.uuids=((t=this.getAttribute("uuids"))==null?void 0:t.split(","))??[],this.uuids}async initComponent(){if(!this.uuidsFromElement){this.error="El atributo 'uuids' es requerido.",this.render();return}this.render()}renderTemplate(){return this.error?`<p style="color: red;">${this.error}</p>`:(window.customElements.get("training-item")||window.customElements.define("training-item",Z),`
            <section
                    class="mt--2 py-sm--5 training height-lg-100"
                    id="training"
            >
                <div class="">
            ...
            </section>`)}}class m extends Error{constructor(e){super(e),this.name="ExperienceError"}}class B{constructor(e){this.repository=e}async execute(e){if(!e)throw new m("El uuid es requerido");return await this.repository.findById(e)}}const w=class w{constructor(){s(this,"store",new Map)}static getInstance(){return w.instance||(w.instance=new w),w.instance}async save(e){this.store.set(e.getUuid(),e)}async findById(e){return this.store.get(e)||null}async findAll(){return Array.from(this.store.values())}async update(e){const t=e.getUuid();if(!this.store.has(t))throw new Error("Experience not found");this.store.set(t,e)}async delete(e){if(!this.store.has(e))throw new Error("Experience not found");this.store.delete(e)}};s(w,"instance");let q=w;class H extends v{constructor(){super(...arguments);s(this,"uuid",null);s(this,"experience",null);s(this,"isLoading",!0);s(this,"error",null)}get uuidFromElement(){return this.uuid=this.getAttribute("uuid"),this.uuid}async initComponent(){if(!this.uuidFromElement){this.error="El atributo 'uuid' es requerido.",this.isLoading=!1,this.render();return}try{const t=new B(q.getInstance());this.experience=await t.execute(this.uuid),this.experience||(this.error="Experience no encontrado.")}catch(t){this.error="Error al cargar la experience.",console.error(t)}finally{this.isLoading=!1,this.render()}}renderTemplate(){if(this.isLoading)return"<p>Cargando experience...</p>";if(this.error)return`<p style="color: red;">${this.error}</p>`;if(!this.experience)return"<p>Experience no disponible.</p>";const t=this.experience;return`
        ...
        `}}class W extends v{constructor(){super(...arguments);s(this,"error",null);s(this,"uuids",[])}get uuidsFromElement(){var t;return this.uuids=((t=this.getAttribute("uuids"))==null?void 0:t.split(","))??[],this.uuids}async initComponent(){if(!this.uuidsFromElement){this.error="El atributo 'uuids' es requerido.",this.render();return}this.render()}renderTemplate(){return this.error?`<p style="color: red;">${this.error}</p>`:(window.customElements.get("experience-item")||window.customElements.define("experience-item",H),`
    ...
    `)}}class G extends v{constructor(){super(...arguments);s(this,"portfolioUuids",[]);s(this,"trainingUuids",[]);s(this,"experienceUuids",[])}uuidsFromElement(){var t,n,i;this.portfolioUuids=((t=this.getAttribute("portfolioUuids"))==null?void 0:t.split(","))??[],this.trainingUuids=((n=this.getAttribute("trainingUuids"))==null?void 0:n.split(","))??[],this.experienceUuids=((i=this.getAttribute("experienceUuids"))==null?void 0:i.split(","))??[]}initComponent(){this.uuidsFromElement(),this.render(),this.menuToggle()}renderTemplate(){return`
        ...
        `}menuToggle(){const t=document.querySelector(".menu-toggle");t&&t.addEventListener("click",n=>{n.preventDefault(),n.stopPropagation(),t.classList.toggle("active")})}}class V{constructor(e,t=document.body){s(this,"curriculumVitae");s(this,"targetElement");this.curriculumVitae=e,this.targetElement=t}async render(){window.customElements.get("portfolio-section")||window.customElements.define("portfolio-section",F),window.customElements.get("training-section")||window.customElements.define("training-section",j),window.customElements.get("experience-section")||window.customElements.define("experience-section",W),window.customElements.get("header-app")||window.customElements.define("header-app",G);const e=this.curriculumVitae.getBasicInfo(),t=this.curriculumVitae.getSkills(),n=this.curriculumVitae.hasPortfolio()?this.curriculumVitae.getPortfolioUuids():[],i=this.curriculumVitae.hasTraining()?this.curriculumVitae.getTrainingUuids():[],o=this.curriculumVitae.hasExperience()?this.curriculumVitae.getExperienceUuids():[];this.targetElement.innerHTML=`
            <div class="">
                <header-app
                        portfolioUuids="${n}"
                        trainingUuids="${i}"
        ...
        `}renderError(e){let t="";e instanceof Error?t+=`<p>${e.name}: ${e.message}</p>`:t+=`<p>Unknown error occurred: ${e}</p>`,this.targetElement.innerHTML=`<div>${t}</div>`}renderTags(e){return e.map(t=>`<span class="tag tag--outline--primary">${t}</span>`).join("")}}class N{constructor(){s(this,"cvs",new Map)}async save(e){this.cvs.set(e.getUuid(),e)}async findById(e){for(const t of this.cvs)if(t[0]===e)return t[1];return null}async findAll(){return Array.from(this.cvs.values())}async update(e){const t=e.getUuid();if(!Array.from(this.cvs.keys()).some(i=>i===t))throw new Error("Curriculum Vitae not found");this.cvs.set(t,e)}async delete(e){if(!this.cvs.has(e))throw new Error("Curriculum Vitae not found");this.cvs.delete(e)}}var l=(r=>(r.LANGUAGES="Lenguajes",r.FRAMEWORKS="Frameworks",r.TOOLS="Herramientas",r.METHODOLOGIES="Metodologías",r.CLOUD="Cloud/DevOps",r.SOFT_SKILLS="Habilidades Blandas",r))(l||{}),x=(r=>(r.ACORUNA="A Coruña",r.MADRID="Madrid",r.REMOTO="Remoto",r))(x||{}),L=(r=>(r.DEVELOPER="Developer",r.DESIGNER="Designer",r.PROJECT_MANAGER="Project Manager",r.DATA_ANALYST="Data Analyst",r.MARKETING="Marketing",r.SALES="Sales",r.HR="Human Resources",r.QA_TESTER="QA Tester",r.OTHER="Other",r))(L||{});class p extends Error{constructor(e){super(e),this.name="CurriculumVitaeErrors"}}class A{constructor(e,t,n,i,o=[x.REMOTO],a,u,b,_=L.OTHER,S=null,C=null,O=null){s(this,"uuid");s(this,"fullName");s(this,"email");s(this,"phone");s(this,"locations");s(this,"specialty");s(this,"linkedin");s(this,"github");s(this,"jobCategories");s(this,"portfolio");s(this,"training");s(this,"experience",null);s(this,"skillSet");A.validateConstructorParams(e,t,n,i,a,u,b),this.uuid=e,this.fullName=t,this.email=n,this.phone=i,this.locations=o,this.specialty=a,this.linkedin=u,this.github=b,this.jobCategories=_,this.skillSet={[l.LANGUAGES]:[],[l.FRAMEWORKS]:[],[l.TOOLS]:[],[l.METHODOLOGIES]:[],[l.CLOUD]:[],[l.SOFT_SKILLS]:[]},this.portfolio=S,this.training=C,this.experience=O}getUuid(){return this.uuid}getPortfolioUuids(){return this.portfolio}hasPortfolio(){return this.portfolio!==null&&this.portfolio.length>0}hasTraining(){return this.training!==null&&this.training.length>0}getTrainingUuids(){return this.training}hasExperience(){return this.experience!==null&&this.experience.length>0}getExperienceUuids(){return this.experience}addSkill(e,t){this.skillSet[e].length&&this.skillSet[e].includes(t)||this.skillSet[e].push(t)}addSkills(e,t){t.forEach(n=>{this.addSkill(e,n)})}getSkills(){return{[l.LANGUAGES]:this.skillSet[l.LANGUAGES],[l.FRAMEWORKS]:this.skillSet[l.FRAMEWORKS],[l.TOOLS]:this.skillSet[l.TOOLS],[l.METHODOLOGIES]:this.skillSet[l.METHODOLOGIES],[l.CLOUD]:this.skillSet[l.CLOUD],[l.SOFT_SKILLS]:this.skillSet[l.SOFT_SKILLS]}}getBasicInfo(){return{fullName:this.fullName,email:this.email,phone:this.phonePrettyPrint(this.phone),locations:this.locations,specialty:this.specialty,linkedin:this.linkedin,github:this.github,jobCategories:this.jobCategories}}addExperience(){}phonePrettyPrint(e){return e.replace(/(.{3})/g,"$1 ").trim()}static validateConstructorParams(e,t,n,i,o,a,u){if(!e)throw new p("UUID no puede estar vacío");if(!t||t.trim().length<2)throw new p("El nombre completo debe tener al menos 2 caracteres");if(!n||!/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(n))throw new p("Email debe tener un formato válido");if(!i||!/^\+?[\d\s\-()]{7,15}$/.test(i))throw new p("Teléfono debe tener un formato válido");if(!o||o.trim().length<3)throw new p("La especialidad debe tener al menos 3 caracteres");if(a&&!a.includes("linkedin.com"))throw new p("LinkedIn debe ser una URL válida");if(!u||!u.includes("github.com")&&!u.includes("github.io"))throw new p("GitHub es obligatorio para developers y debe ser una URL válida")}}class z extends A{constructor(e,t,n,i,o=[x.REMOTO],a,u,b,_=null,S=null,C=null){super(e,t,n,i,o,a,u,b,L.DEVELOPER,_,S,C)}}class c{constructor(e,t,n,i,o,a=null){s(this,"uuid");s(this,"title");s(this,"description");s(this,"technologies");s(this,"imageUrl");s(this,"url");c.validateConstructorParams(e,t,n,i,o),this.uuid=e,this.title=t,this.description=n,this.technologies=i,this.imageUrl=o,this.url=a}getUuid(){return this.uuid}getTitle(){return this.title}getDescription(){return this.description}getTechnologies(){return this.technologies}getImageUrl(){return this.imageUrl}getUrl(){return this.url}copyWith(e){const t={uuid:this.uuid,title:e.title??this.title,description:e.description??this.description,technologies:e.technologies??this.technologies,imageUrl:e.imageUrl??this.imageUrl,url:e.url??this.url};return c.validateConstructorParams(t.uuid,t.title,t.description,t.technologies,t.imageUrl),new c(t.uuid,t.title,t.description,t.technologies,t.imageUrl,t.url)}updateTitle(e){return this.copyWith({title:e})}updateDescription(e){return this.copyWith({description:e})}updateTechnologies(e){return this.copyWith({technologies:e})}updateImageUrl(e){return this.copyWith({imageUrl:e})}updateUrl(e){return this.copyWith({url:e})}static validateConstructorParams(e,t,n,i,o){if(!e)throw new E("Uuid es requerido");if(!t)throw new E("Title es requerido");if(!n)throw new E("Description es requerido");if(!i||i.length===0)throw new E("Technologies es requerido");if(!o)throw new E("ImageUrl es requerido")}getBasicInfo(){return{uuid:this.uuid,title:this.title,description:this.description,imageUrl:this.imageUrl,url:this.url}}}class K{constructor(e){this.repository=e}async execute(e){await this.repository.save(e)}}class d{constructor(e,t,n,i,o,a=null){s(this,"uuid");s(this,"title");s(this,"description");s(this,"location");s(this,"date_from");s(this,"date_to");d.validateConstructorParams(e,t,n,i,o),this.uuid=e,this.title=t,this.description=n,this.location=i,this.date_from=o,this.date_to=a??null}getUuid(){return this.uuid}getTitle(){return this.title}getDescription(){return this.description}getLocation(){return this.location}getDateFrom(){return this.date_from}getDateTo(){return this.date_to}copyWith(e){const t={uuid:this.uuid,title:e.title??this.title,description:e.description??this.description,location:e.location??this.location,date_from:e.date_from??this.date_from,date_to:e.date_to??this.date_to};return d.validateConstructorParams(t.uuid,t.title,t.description,t.location,t.date_from),new d(t.uuid,t.title,t.description,t.location,t.date_from,t.date_to)}static validateConstructorParams(e,t,n,i,o){if(!e)throw new y("Uuid es requerido");if(!t)throw new y("Title es requerido");if(!n)throw new y("Description es requerido");if(!i)throw new y("Location es requerido");if(!o)throw new y("Location es requerido")}getBasicInfo(){return{uuid:this.uuid,title:this.title,description:this.description,location:this.location,date_from:this.date_from,date_to:this.date_to}}}class Q{constructor(e){this.repository=e}async execute(e){await this.repository.save(e)}}class h{constructor(e,t,n,i,o,a){s(this,"uuid");s(this,"title");s(this,"description");s(this,"skills");s(this,"date");s(this,"logoPath");h.validateConstructorParams(e,t,n,i,o,a),this.uuid=e,this.title=t,this.description=n,this.skills=i,this.date=o,this.logoPath=a}getUuid(){return this.uuid}getTitle(){return this.title}getDescription(){return this.description}getSkills(){return this.skills}getDate(){return this.date}getLogoPath(){return this.logoPath}copyWith(e){const t={uuid:this.uuid,title:e.title??this.title,description:e.description??this.description,skills:e.skills??this.skills,date:e.date??this.date,logoPath:e.logoPath??this.logoPath};return h.validateConstructorParams(t.uuid,t.title,t.description,t.skills,t.date,t.logoPath),new h(t.uuid,t.title,t.description,t.skills,t.date,t.logoPath)}static validateConstructorParams(e,t,n,i,o,a){if(!e)throw new m("Uuid es requerido");if(!t)throw new m("Title es requerido");if(!n)throw new m("Description es requerido");if(!i)throw new m("Skills es requerido");if(!o)throw new m("Date es requerido");if(!a)throw new m("LogoPath es requerido")}getBasicInfo(){return{uuid:this.uuid,title:this.title,description:this.description,skills:this.skills,date:this.date}}}class X{constructor(e){this.repository=e}async execute(e){await this.repository.save(e)}}class Y{async generateCv(){const e=await this.generatePortfolioUuids(),t=await this.generateTrainingUuids(),n=await this.generateExperienceUuids(),i=new z("9f863328-1fb1-432e-a56b-70189492c37b","Cristobal Terceiro","cristojvt@gmail.com","+34697356153",[x.ACORUNA,x.REMOTO],"Desarrollador Full-Stack con más de 15 años de experiencia en todo tipo de proyectos para clientes","https://www.linkedin.com/in/cristobal-terceiro","https://github.com/cristoj",e,t,n);return i.addSkills(l.LANGUAGES,["html","css","js","ts","php","dart"]),i.addSkills(l.FRAMEWORKS,["Angular","React","Flutter","Laravel","WordPress","Astro"]),i.addSkills(l.CLOUD,["GitHub","AWS","Vercel","Cloudflare","Firebase","Mailchimp"]),i.addSkills(l.METHODOLOGIES,["Scrum"]),i.addSkills(l.TOOLS,["Docker","Postman","Sonarqube","VS Code","PHP Storm","Xcode","Android Studio","XD","Photoshop"]),i}async generatePortfolioUuids(){const e=[new c("14207ae2-0b3d-40af-a06b-07c2b5c9ceb7","STIK","SaaS de CX con uso de reconocimiento de imagen. Desarrollo de panel de administración, panel de clientes, webs corporativas y app móvil",["Angular","React","Flutter","Laravel","AWS","Cloudflare","Firebase"],"assets/images/portfolio/stik.jpg","https://www.stik.world"),new c("15a3c319-abf7-4b44-b5c9-78d2ce000576","CEOENet","Intranet de CEOE para sus asociados. Desarrollo de panel de clientes y app móvil",["Angular","Flutter"],"assets/images/portfolio/ceoenet.jpg","https://ceoe.net"),new c("87cb94cd-a6c7-4789-9be1-a9f8a5543eaa","Fundación CEOE","Web corporativa de la Fundación CEOE",["WordPress"],"assets/images/portfolio/fundacion-ceoe.jpg","https://www.fundacionceoe.es/"),new c("2dab667a-0385-41a7-abd9-6834c83f7ff8","CEPYME500","Proyecto Empresarial con las 500 pymes con mayor crecimiento del año. Web corporativa, panel de usuarios y aplicación móvil",["Angular","Flutter","Stripe","AWS"],"assets/images/portfolio/cepyme500.jpg","https://www.cepyme500.es"),new c("0187f894-eda7-48ec-9e0a-c72688314b1d","Juntos Separamos","Proyecto web para la Diputación de Ourense. Panel de gestión de residuos de la provincia de Ourense",["Angular","laravel"],"assets/images/portfolio/juntosseparamos.jpg","https://juntosseparamos.depourense.es"),new c("db7378b4-5ef1-46bb-abdb-1cea6963da6b","Rec Parenting","Plataforma donde psicólogos conectan con sus pacientes por medio de videoconferencias. Web corporativa con pagos, plataforma web y app móvil",["Angular","Flutter","Wordpress","Stripe","AWS"],"assets/images/portfolio/recparenting.jpg","https://www.recparenting.com"),new c("8627492d-59c9-4296-8484-bf058a840e51","CEOETech","La mayor plataforma de información legislativa nacional y europea. Panel de administración de usuarios y buscador de ayudas y subvenciones con pasarela de pago",["Laravel","Stripe"],"assets/images/portfolio/ceoetech.jpg","https://ceoe.tech"),new c("5938e62e-b521-41b5-be88-291a706cd716","Podoclínica","Gestión de clínica podológica. Panel de administración vía plataforma web con reservas de citas",["Angular","Laravel","AWS"],"assets/images/portfolio/podoclinicacoruna.jpg","https://gestion.podoclinicacoruna.es")],t=T.getInstance(),n=new K(t);return await Promise.all(e.map(async i=>(await n.execute(i),i.getUuid())))}async generateTrainingUuids(){const e=[new d("10e3df13-f7e1-44e7-8ea4-bb0194966652","Grado Ingeniería Informática","UNED","Online","2024","~"),new d("140dea6b-cee9-427d-9ffd-b37d22a08491","Emprendimiento y Startups","ISDI | EOI","Online","2025"),new d("15cb64ec-a90d-48a0-a843-bda67295a34d","AWS Developer","CNTG","Online","2024"),new d("6ebf2c71-4ee4-4e25-99e2-1e3d6bf06611","SCRUM Master","Scrum.org","Online","2020",null),new d("9a790036-0730-412e-9d63-87e3e3b14dac","AWS Solution Architect","CNTG","Online","2015","2016"),new d("190ce9a0-d400-42e6-a8fd-260613be9543","Técnico Superior en desarrollo de Aplicaciones Web","FP Fernando Wirtz","A Coruña","2012","2013"),new d("850bfab6-958d-429c-8a62-517545962552","CORE Fundamentos de un proyecto TI","EUCIP","Online","2011",null),new d("9b786f3d-4d9d-4746-9532-4d55f33e48d9","Recursos y lenguajes entornos WEB","UNED","Online","2011",null)],t=U.getInstance(),n=new Q(t);return await Promise.all(e.map(async i=>(await n.execute(i),i.getUuid())))}async generateExperienceUuids(){const e=[new h("6c18232b-fc61-46f0-b11f-7b5ba91dfe54","STIK","Startup con producto propio. Red social + plataforma de CX basada en productos con tecnología de IA+RI.","Desarrollo FrontEnd y móvil en coordinación con el equipo de BackEnd. Aportación de conocimientos de emprendimiento para el proyecto en general.","2024/~","logo_stik.png"),new h("20922240-dbb0-43b1-b589-6d614fe3076e","UPMEDIA","Consultora tecnológica y agencia de comunicación","Desarrollo FullStack y móvil para los diferentes clientes de la empresa (CEPYME, CEOE, Cafés Siboney, Central Lechera Asturiana, Ecoembes, etc.).","2016/2024","logo_upmedia.png"),new h("b69494d5-92ee-45f5-809c-76948d5f3fe1","Trocobuy","Portal web de intercambio de productos y servicios empresariales","Desarrollo FrontEnd de la parte privada del portal","2011/2016","logo_trocobuy.png"),new h("a916ece1-bcc5-41f7-93b6-fa41ff69cc2b","Iberfinancia","Agencia de financiación privada","Desarrollo de minisites para clientes y gestión de email-marketing.","2009/2011","logo_iberfinancia.png")],t=q.getInstance(),n=new X(t);return await Promise.all(e.map(async i=>(await n.execute(i),i.getUuid())))}}async function J(){const r=new N,e=new I(r),n=await new Y().generateCv();await e.execute(n),document.addEventListener("DOMContentLoaded",async()=>{const i=document.getElementById("app")??void 0;await new V(n,i).render()})}J().catch(r=>{new k().render(r)});
